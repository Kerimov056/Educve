...
<head>
  ...
  <body>
    ...
    <!-- End Header Section -->
    <!-- Start Hero Section -->
    <section class="td_hero td_style_1 td_heading_bg td_center td_bg_filed" data-src="{{ asset('assets/img/home_1/hero_bg_1.jpg') }}">
      <div class="container">
...
<a href="https://www.youtube.com/embed/rRid6GCJtgc" class="td_circle_text td_center td_video_open">
  ...
  <div class="td_card_info td_white_bg">
    <div class="td_card_info_in">
      ...
      <a href="courses-grid-with-sidebar.html" class="td_card_category td_fs_14 td_bold td_heading_color td_mb_14">
        <span>Data Analytics</span>
      </a>
      <h2 class="td_card_title td_fs_24 td_mb_16">
        <a href="course-details.html">Starting Reputed Education & Build your Skills</a>
      </h2>
  ...
  <div class="td_card td_style_3 d-block td_radius_10">
    ...
    <div class="td_card_info td_white_bg">
      <div class="td_card_info_in">
        ...
        <h2 class="td_card_title td_fs_24 td_mb_16">
          <a href="course-details.html">Master Technology & Elevate Your Career</a>
        </h2>
        <p class="td_card_subtitle td_heading_color td_opacity_7 td_mb_20">
  ...
  <div class="td_card td_style_3 d-block td_radius_10">
    ...
    <div class="td_card_info td_white_bg">
      <div class="td_card_info_in">
        ...
        <h2 class="td_card_title td_fs_24 td_mb_16">
          <a href="course-details.html">Boost Creativity & Expand Your Horizons</a>
        </h2>
        <p class="td_card_subtitle td_heading_color td_opacity_7 td_mb_20">
...
<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
  <div class="td_card td_style_3 d-block td_radius_10">
    <a href="course-details.html" class="td_card_thumb">
      <img src="{{ asset('assets/img/home_1/course_thumb_4.jpg') }}" alt="">
    </a>
    <div class="td_card_info td_white_bg">
      <div class="td_card_info_in">
        <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
...
<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
  <div class="td_card td_style_3 d-block td_radius_10">
    <a href="course-details.html" class="td_card_thumb">
      <img src="{{ asset('assets/img/home_1/course_thumb_5.jpg') }}" alt="">
    </a>
    <div class="td_card_info td_white_bg">
      <div class="td_card_info_in">
        <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
...
<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
  <div class="td_card td_style_3 d-block td_radius_10">
    <a href="course-details.html" class="td_card_thumb">
      <img src="{{ asset('assets/img/home_1/course_thumb_6.jpg') }}" alt="">
    </a>
    <div class="td_card_info td_white_bg">
      <div class="td_card_info_in">
        <ul class="td_card_meta td_mp_0 td_fs_18 td_medium td_heading_color">
  ...
  <div class="container">
    <div class="td_features td_style_1 td_hobble">
      <div class="td_features_thumb">
        <img src="{{ asset('assets/img/home_1/feature_img.jpg') }}" alt="" class="td_radius_10 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
      </div>
          ...
          <div class="td_card_info">
            <div class="td_card_info_in">
              ...
              <p class="td_mb_30 td_fs_18">
                Education is a dynamic and evolving field that plays a crucial role in shaping individuals and societies...
              </p>
    ...
    <div class="row align-items-center td_gap_y_40">
      <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
        <div class="td_testimonial_img_wrap">
          <img src="{{ asset('assets/img/home_1/testimonial_img.png') }}" alt="" class="td_testimonial_img">
          ...
          <span class="td_testimonial_img_shape_2 td_accent_color td_hover_layer_3">
            <svg width="145" height="165" viewBox="0 0 145 165" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M145.003 25.9077L139.516 27.7024L143.814 31.5573L145.003 25.9077Z..." fill="white"/>
            ...
            <div class="td_slider_wrapper">
                ...
                <div class="td_testimonial td_style_1 td_white_bg td_radius_5">
                  <span class="td_quote_icon td_accent_color">
                    <svg width="65" height="46" viewBox="0 0 65 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path opacity="0.05" d="M13.9286 26.6H1V1H26.8571V27.362L17.956 45H6.26764..." fill="currentColor" stroke="currentColor" stroke-width="2"/>
                    </svg>
                  </span>              
                  ...
                  <blockquote class="td_testimonial_text td_fs_20 td_medium td_heading_color td_mb_24 td_opacity_9">
                    The pandemic has accelerated the shift to online and hybrid learning models. Platforms like Coursera, edX, and university-specific online programs offer flexibility and accessibility to a wider audience.
                  </blockquote>
                  <div class="td_rating" data-rating="5">
                    <i class="fa-regular fa-star"></i>
                    <i class="fa-regular fa-star"></i>
              ...
              <div class="td_slide">
                <div class="td_testimonial td_style_1 td_white_bg td_radius_5">
                  ...
                  <div class="td_testimonial_meta td_mb_24">
                    <img src="{{ asset('assets/img/home_2/avatar_2.png') }}" alt="">
                    <div class="td_testimonial_meta_right">
